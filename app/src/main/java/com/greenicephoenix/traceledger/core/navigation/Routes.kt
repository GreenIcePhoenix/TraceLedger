...
object Routes {
    ...
    // REMOVED: PRIVACY_POLICY and TERMS no longer exist as in-app screens.
    // Both pages are served from the website (traceledger.pages.dev).
    // AboutScreen opens them via LocalUriHandler — no navigation routes needed.
